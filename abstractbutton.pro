...
UBUNTU_TRANSLATION_DOMAIN="abstractbutton.liu-xiao-guo"
...
aptest.commands = bash $$PWD/abstractbutton/tests/autopilot/run
aptest.depends  = sub-abstractbutton

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/abstractbutton/tests/unit
unittest.depends  = sub-abstractbutton
